    ...
    <form method="post" action="options.php"> 
        ...
        <table class="form-table">  
            <tr valign="top">
                ...
                <td><input type="text" name="sp_apikey_file_location" id="sp_apikey_file_location" value="<?php echo get_option('sp_apikey_file_location'); ?>" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="sp_directory_href">Directory HREF</label></th>
                <td><input type="text" name="sp_directory_href" id="sp_directory_href" value="<?php echo get_option('sp_directory_href'); ?>" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="sp_application_href">Application HREF</label></th>
                <td><input type="text" name="sp_application_href" id="sp_application_href" value="<?php echo get_option('sp_application_href'); ?>" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="sp_idsite_login_uri">ID Site Login URI</label></th>
                <td><input type="text" name="sp_idsite_login_uri" id="sp_idsite_login_uri" value="<?php echo get_option('sp_idsite_login_uri'); ?>" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="sp_idsite_logout_uri">ID Site Logout URI</label></th>
                <td><input type="text" name="sp_idsite_logout_uri" id="sp_idsite_logout_uri" value="<?php echo get_option('sp_idsite_logout_uri'); ?>" /></td>
            </tr>
            <tr valign="top">
